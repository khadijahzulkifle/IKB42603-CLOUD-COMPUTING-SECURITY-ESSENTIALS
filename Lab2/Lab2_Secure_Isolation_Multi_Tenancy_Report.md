...
Kubernetes namespaces separate resources, but they do not block network communication. Without a NetworkPolicy, one tenant can communicate with another tenant's services, creating security risks.

---

## Q2. Explain the default-deny principle and how your NetworkPolicy implements it.

The default-deny principle blocks all traffic unless it is allowed. The NetworkPolicy blocks incoming traffic to tenant-b, so the connection from tenant-a is blocked and times out.

---

## Q3. How do virtual machines and containers differ in isolation strength? When would you add a VM boundary?

Containers share the host operating system kernel, while virtual machines have their own operating system and kernel. VMs provide stronger isolation and are useful for sensitive workloads or higher security requirements.

---

## Q4. What is data remanence, and why is cryptographic erasure the preferred cloud solution?

Data remanence means data may still remain after deletion. In the cloud, users usually cannot control the physical storage, so cryptographic erasure is useful. Destroying the encryption key makes the data inaccessible.
